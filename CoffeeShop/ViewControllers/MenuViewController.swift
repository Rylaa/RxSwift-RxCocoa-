...
class MenuViewController: BaseViewController {
    ...
    private lazy var coffees: Observable<[Coffee]> = {
        ...
        return .just([espresso, cappuccino, macciato, mocha, latte])// Observable değişkenimizin hiç bir zaman değişmeyeceğini gösteriyor
    ...
    override func viewDidLoad() {
        ...
        coffees
            .bind(to: tableView
                .rx
                .items(cellIdentifier: "coffeeCell", cellType: CoffeeCell.self)) {
                    row, element, cell in
